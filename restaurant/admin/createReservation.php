...
<body> 
    <div class="wrapper"> 
        ...
        <div id="Search Table"> 
        <form id="reservation-form" method="GET" action="availability.php" class="ht-600 w50"> 
            <div class="form-group"> 
                <label for="reservation_date" >Select Date</label><br> 
                <input class="form-control" type="date" id="reservation_date" 
name="reservation_date" required><br> 
            </div> 
...
class="form-control" required placeholder="Johnny Hatsoff"><br> 
                        </div> 
                        <?php 
                        ...
                        <div class="form-group"> 
                            ...
                            <select class="form-control" name="table_id" id="table_id_reserve" 
required> 
                        ...
                        <div class="form-group" > 
                            ...
                            <input type="text" id="special_request" name="special_request" class="ht
600 w-50" placeholder="One baby chair"><br> 
                        </div> 
                         
                        <div class="form-group mt-2"> 
                            <input type="submit" name="submit" class="btn btn-dark" value="Make 
Reservation"> 
                        </div>                         
                    </form> 
                </div> 
